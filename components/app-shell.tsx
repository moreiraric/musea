...
export function AppShell({ children }: AppShellProps) {
  return (
    <div className="min-h-dvh bg-[radial-gradient(circle_at_top,_#f2f2f2,_#e6e3dd)] p-4 text-foreground">
      <div className="relative mx-auto h-[874px] w-[402px] rounded-[56px] border border-black/10 bg-[#0b0b0b] p-[10px] shadow-[0_25px_60px_-30px_rgba(0,0,0,0.45)]">
        ...
        <div className="relative flex h-full flex-col overflow-hidden rounded-[44px] bg-background">
          <TopNav />
